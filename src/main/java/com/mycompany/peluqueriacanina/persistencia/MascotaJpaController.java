...
public class MascotaJpaController implements Serializable {
    ...
    public List<Mascota> findMascotaEntities(int maxResults,  int firstResults){
        return findMascotaEntities(false, maxResults, firstResults);
    }
    
    private List<Mascota> findMascotaEntities(boolean all, int maxResults,  int firstResults){
